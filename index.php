            ...
            <div class="container">
                <div class="row justify-content-start">
                    <div class="col-10 col-lg-8">
                        ...
                        <a href="./Guest/Login.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Login</a>
                        <a href="./Guest/User.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">SignUp</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="./Assets/Templates/Main/img/service-1.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">Plumbers</h5>
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="./Guest/Login.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="./Assets/Templates/Main/img/service-2.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">Cleaners</h5>
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="./Guest/Login.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
                    <div class="overflow-hidden">
                        <img class="img-fluid w-100 h-100" src="./Assets/Templates/Main/img/service-3.jpg" alt="">
                    </div>
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        <h5 class="text-truncate me-3 mb-0">Welders</h5>
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="./Guest/Login.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4 text-center wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p class="text-white mb-0">Registered Workers</p>
                </div>
                ...
                <div class="col-md-6 col-lg-4 text-center wow fadeIn" data-wow-delay="0.7s">
                    ...
                    <h2 class="text-white mb-2" data-toggle="counter-up">1234</h2>
                    <p class="text-white mb-0">Jobs Completed</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
               <h6 class="text-secondary text-uppercase">Our Workers</h6>
                <h1 class="mb-5">Meet Skilled Professionals</h1>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./Assets/Templates/Main/img/team-1.jpg" alt="">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">Full Name</h5>
                                <small>Designation</small/Assets/Templates/Main/>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./Assets/Templates/Main/img/team-2.jpg" alt="">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">Full Name</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./Assets/Templates/Main/img/team-3.jpg" alt="">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">Full Name</h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./Assets/Templates/Main/img/team-4.jpg" alt="">
                        </div>
                        <div class="team-text">
                            <div class="bg-light">
                                <h5 class="fw-bold mb-0">Full Name</h5>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="mb-5">What Our Users Say</h1>
            ...
            <div class="owl-carousel testimonial-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="./Assets/Templates/Main/img/testimonial-1.jpg" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="./Assets/Templates/Main/img/testimonial-2.jpg" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="./Assets/Templates/Main/img/testimonial-3.jpg" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <img class="bg-light rounded-circle p-2 mx-auto mb-2" src="./Assets/Templates/Main/img/testimonial-4.jpg" style="width: 80px; height: 80px;">
                    <div class="mb-2">
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
                        <small class="fa fa-star text-secondary"></small>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>kothamagalam</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 8891848165</p>
