        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Kothamangalam</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a class="btn btn-link" href="">AC Mechanic</a>
                    <a class="btn btn-link" href="">Cleaner</a>
                    <a class="btn btn-link" href="">Welder</a>
