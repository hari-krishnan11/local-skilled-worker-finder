...
session_start();
	...
	if(isset($_POST["btn_pay"]))
	{
				...
				$a = "update tbl_request set request_status='4' where request_id='".$_GET["bid"]."'";
				if($Con->query($a))
				{
...
<body>
	<div class="wrapper">
		...
		<form method="POST">
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="tel" id="txtcardno" name="txtcardno"
       maxlength="19"
       ...
       placeholder="Card Number" required>
			...
			<div class="input-group">
				<div class="input-box">
					<input class="name" type="password" id="txtcvc" name="txtcvc"
               maxlength="3"
               placeholder="CVC" required>
					<i class="fa fa-user icon" aria-hidden="true"></i>
				</div>
				<div class="input-box">
					<<input class="name" type="text" id="txtexp" name="txtexp"
               maxlength="5"
